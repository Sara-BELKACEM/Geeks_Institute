...
# Exercise08
ansdwich_orders = ["Tuna sandwich", "Pastrami sandwich", "Avocado sandwich",
                    "Pastrami sandwich", "Egg sandwich", "Chicken sandwich", 
                    "Pastrami sandwich"]

while "Pastrami sandwich" in ansdwich_orders:
    ansdwich_orders.remove("Pastrami sandwich")

finished_sandwiches = []


for sandwich in ansdwich_orders:
